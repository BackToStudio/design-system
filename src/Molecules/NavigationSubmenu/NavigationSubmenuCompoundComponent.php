...
class NavigationSubmenuCompoundComponent extends TokenComponent implements MoleculeInterface
{
	...
	public function getMarkup(): string
	{
		...
		$this->getButton()->addAttribute(
			'x-bind:class',
			'isSubmenuOpen ? "text-secondary-500 lg:text-primary-300 [&_svg]:rotate-180 [&_svg]:origin-center [&_svg]:transition-transform [&_svg]:duration-300 [&_svg]:ease-in-out" : "[&_svg]:rotate-0 [&_svg]:origin-center [&_svg]:transition-transform [&_svg]:duration-300 [&_svg]:ease-in-out"'
		);
